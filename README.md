...
```bash
git clone https://github.com/coderfeye13/book-recommendation-chatbot
...
- _"I want something funny and lighthearted"_
- _"Recommend a dark dystopian novel"_
- _"I'm a software engineer, what should I read?"_
- _"Something inspiring for when I'm feeling lost"_
- _"I loved Dune, what's similar?"_
